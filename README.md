...
**`%%testcell`** executes notebook cells in isolation: no symbols leak
into your global namespace. Test code, try snippets, and experiment
freely: no variables, functions, classes, or imports left behind.  
